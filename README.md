...
|---------|----------|-----------|
| Python support | 3.10 only | **3.10, 3.11, 3.12** |
| torch / torchvision | 2.1.2 / 0.16.2 (cu121) | **2.6.0 / 0.21.0 (cu124)** |
| xformers | 0.0.23.post1 | **0.0.29.post3** |
| transformers | 4.30.2 | **4.57.6** |
| gradio | 3.41.2 | **3.50.2** |
| pytorch_lightning | 1.9.4 | **2.6.1** |
| accelerate | 0.21.0 | **1.13.0** |
| Pillow | 9.5.0 | **10.4.0** |
| numpy | 1.26.2 | **1.26.4** |
| safetensors | 0.4.2 | **0.7.0** |
| open-clip-torch | 2.20.0 | **3.3.0** |
| scikit-image | 0.21.0 | **0.26.0** |
| protobuf | ==3.20.0 (hard pin) | **>=5.29.0** |
| + many others | — | see `requirements_versions.txt` |

> **Branch `torch-bleeding-edge`**: torch **2.10.0** (CUDA 12.8 bundled) + xformers **0.0.35**.
> Requires NVIDIA driver ≥ 560. See that branch's README for details.
