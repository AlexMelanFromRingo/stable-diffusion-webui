...
This program is tested with Python 3.10–3.12, but you have {major}.{minor}.{micro}.
If you encounter an error with "RuntimeError: Couldn't install torch." message,
or any other error regarding unsuccessful package (library) installation,
please use Python 3.10, 3.11, or 3.12 and delete the "venv" folder in WebUI's directory.
...
def prepare_environment():
    ...
    _torch_extra = f" --extra-index-url {torch_index_url}" if torch_index_url else ""
    torch_command = os.environ.get('TORCH_COMMAND', f"pip install torch==2.10.0 torchvision==0.25.0{_torch_extra}")
    if args.use_ipex:
    ...
    taming_transformers_commit_hash = os.environ.get('TAMING_TRANSFORMERS_COMMIT_HASH', "3ba01b241d3eff6a6c4e8b4b994cf70c92c21909")
